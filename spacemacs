...
before packages are loaded."
  ...
  (with-eval-after-load 'org
    ...
    (let ((maildir (mu4e-message-field msg :maildir))
          ...
          folder)
      (cond
      ((string-match "crymer-rentpath" maildir)
